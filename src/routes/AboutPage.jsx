...
const AboutPage = () => {
  ...
  return (
    <div className="about-page" style={pageVariables}>
      <style>{`
      ...
      <main className="about-main">
        ...
        <section className="about-institutions" aria-label="Institutions where Astra users practice and train">
        ...
        <section className="about-section about-section--first">
          ...
          <figure className="about-study-figure">
          ...
          <div className="about-interpretation">
        ...
        <section className="about-section">
          ...
          <div className="about-evidence-grid">
            <article className="about-evidence-card">
        ...
        <section className="about-section">
          ...
          <div className="about-mode-grid">
            {MODES.map(({ icon: Icon, name, headline, text }) => (
              <article className="about-mode" key={name}>
          ...
          <button className="about-sources-button" type="button" onClick={() => navigate('/sources')}>
        ...
        <section className="about-section">
          ...
          <div className="about-principles">
            {PRINCIPLES.map((principle) => (
              <div className="about-principle" key={principle.label}>
        ...
        <section className="about-section">
          ...
          <div className="about-study-list">
            {STUDIES.map((study) => (
              <a className="about-study-row" href={study.url} target="_blank" rel="noreferrer" key={study.title}>
